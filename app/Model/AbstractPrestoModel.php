...
abstract class AbstractPrestoModel implements BIModelInterface
{
    ...
    protected static $tableMaps = [
        ...
        //TODO 上线dwsslave改为dws
        'table_dws_idm_category01_topn_kpi' => 'dwsslave.dws_dataark_idm_category01_topn_kpi_tmp',
        'table_dws_idm_category02_topn_kpi' => 'dwsslave.dws_dataark_idm_category02_topn_kpi_tmp',
        'table_dws_idm_category03_topn_kpi' => 'dwsslave.dws_dataark_idm_category03_topn_kpi_tmp',
