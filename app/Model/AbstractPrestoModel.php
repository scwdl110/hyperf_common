...
abstract class AbstractPrestoModel implements BIModelInterface
{
    ...
    protected $bigUserTable = array(
        "dws_dataark_f_dw_goods_day_report_{DBHOST}",
        "dws_dataark_f_dw_goods_month_report_{DBHOST}",
        "dws_dataark_f_dw_channel_day_report_{DBHOST}",
        "dws_dataark_f_dw_channel_month_report_{DBHOST}",
    );
