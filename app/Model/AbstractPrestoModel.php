...
//                $sql = "create Table {$this->exportTmp}{$this->tmpTable} as ({$sql})";
    ...
    public function __get(string $name)
    {
        if (array_key_exists($name, self::$tableMaps)) {
            ...
            $fba_arr = array(
                "ods_g_amazon_fba_inventory_v3_tend_001",
                "ods_g_amazon_fba_inventory_v3_001",
                "ods_g_amazon_fba_inventory_v3_rel_001",
                "ods_e_erp_storage_inventory_warehouse_report_001",
                "ods_e_erp_storage_warehouse_isku_001",
            );
