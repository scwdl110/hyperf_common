...
class ChannelModel extends Model
{
    ...
    public function getChannelOperationPatternList($user_id)
    {
        ...
        if (false===$channel_operation_data) {
            ...
            $channel_operation_data = Unique::getArray(UserAdminModel::where($where)->get(["id","operation_user_admin_id"]));
            $this->redis->set($redis_key, $channel_operation_data,4*60*60);
        }
