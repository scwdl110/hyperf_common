...
class AmazonGoodsFinanceReportByOrderPrestoModel extends AbstractPrestoModel
{
    ...
    public function getCompareDatas($datas , $type = 0 ,$exchangeCode = 1 , $day_param = 1){
        ...
        if($type == '1'){
            $mod_where = "report.user_id={$datas['user_id']} AND amazon_goods.goods_user_id={$datas['user_id']} AND report.user_id_mod = " . $this->dws_user_id_mod . " and amazon_goods.goods_user_id_mod=" . $this->dws_user_id_mod;
